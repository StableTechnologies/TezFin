...
class Contract(sp.Contract):
  ...
  def accrueInterest(self, params):
    sp.set_type(params, sp.TUnit)
    compute_CFA2_45 = sp.local("compute_CFA2_45", (self.data.currentCash + self.data.totalSupply) + self.data.totalReserves)
    sp.if compute_CFA2_45.value > 0:
