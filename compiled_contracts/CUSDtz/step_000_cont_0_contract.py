...
class Contract(sp.Contract):
  def __init__(self):
    ...
    self.init(accrualBlockNumber = 0,
              ...
              ledger = {},
              metadata = {'' : sp.bytes('0x74657a6f732d73746f726167653a64617461'), 'data' : sp.bytes('')},
              ...
              token_metadata = {0 : sp.record(token_id = 0, token_info = {'decimals' : sp.bytes('0x36'), 'name' : sp.bytes('0x54657a46696e20496e7465726573742d42656172696e67205553442054657a'), 'symbol' : sp.bytes('0xea9cb0555344747a')})},
              totalBorrows = 0,
              totalReserves = 0,
              totalSupply = 0)
  ...
  def liquidateBorrow(self, params):
    ...
    sp.transfer(sp.record(from_ = sp.sender, to_ = sp.self_address, value = repayAmount.value), sp.tez(0), sp.contract(sp.TRecord(from_ = sp.TAddress, to_ = sp.TAddress, value = sp.TNat).layout(("from_ as from", ("to_ as to", "value"))), self.data.fa1_2_TokenAddress, entrypoint='transfer').open_some())
