...
tstorage = sp.TRecord(admin = sp.TAddress, alias = sp.TBigMap(sp.TString, sp.TString), oracle = sp.TAddress, overrides = sp.TBigMap(sp.TString, sp.TPair(sp.TTimestamp, sp.TNat)), pendingAdmin = sp.TOption(sp.TAddress), usdtOracle = sp.TAddress).layout((("admin", ("alias", "oracle")), ("overrides", ("pendingAdmin", "usdtOracle"))))
