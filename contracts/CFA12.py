...
class CFA12(CToken.CToken):
    def __init__(self, scale_, scaleUnderlying_, comptroller_, interestRateModel_, initialExchangeRateMantissa_, administrator_, fa1_2_TokenAddress_, **extra_storage):
