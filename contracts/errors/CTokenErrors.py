class ErrorCodes:
    ...
    CT_LIQUIDATE_COMPTROLLER_REJECTION = "CT_LIQUIDATE_COMPTROLLER_REJECTION" # liquodate op rejected by comptroller
    CT_LIQUIDATE_LIQUIDATOR_IS_BORROWER = "CT_LIQUIDATE_LIQUIDATOR_IS_BORROWER" # liquidator and borrower addresses same in liquidate token call
    CT_LIQUIDATE_CLOSE_AMOUNT_IS_INVALID = "CT_LIQUIDATE_CLOSE_AMOUNT_IS_INVALID" # repay amount in liquidate call <= 0 
