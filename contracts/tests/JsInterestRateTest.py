...
RV = sp.io.import_script_from_url(
    "file:contracts/tests//utils/ResultViewer.py")
...
def test():
    ...
    scenario.h1(
        "Test cases from the tests in the  JS implemetation for Supply and Borrow  rate")
    ...
    c2 = IRM.InterestRateModel(
        scale_=expScale, multiplierPerBlock_=multiplierPerBlock, baseRatePerBlock_=baseRatePerBlock)
    scenario += c2
