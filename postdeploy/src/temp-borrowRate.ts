...
function _getBorrowRate(
	borrrowRateParams :BorrowRateParameter
): bigInt.BigInteger {
  const borrowRate = _calcBorrowRate(
    borrowRateParams.borrows,
    rescale(borrowRateParams.cash,borrowRateParams.underlyingExpScale,borrowRateParams.ctokenExpScale),
    borrowRateParams.reserves,
    borrowRateParams.ctokenExpScale,
    borrowRateParams.irmExpScale,
    borrowRateParams.multiplierPerBlock,
    borrowRateParams.baseRatePerBlock
  );
...
*/
  return rescale(borrowRate, borrowRateParams.irmExpScale, borrowRateParams.ctokenExpScale);
}
