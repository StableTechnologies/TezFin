...
const Market = () => {
    ...
    return (
        <Grid container className={classes.container}>
            <Grid item xs={12}>
                <Typography className={classes.tableTitle}> Recent Liquidations </Typography>
                                    ...
                                    <TableRow key={data.title}>
                                        <TableCell>
                                            <div className={classes.flexAdd}>
                                                <Typography className={classes.cellContent}> tz1aMQrJ...wGUuKg </Typography> {/* //change class name */}
                                        ...
                                        <TableCell align="right">
                                            <div className={`${classes.flexAdd} ${classes.alignTokens}`}>
                                                <img src={data.logo} alt={`${data.title}-Icon`} className={classes.img} />
                                                <Typography className={classes.cellContent}> {' '} {data.title} </Typography>
                                            </div>
                                        </TableCell>
                                        <TableCell align="right">
                                            <div className={`${classes.flexAdd} ${classes.alignTokens}`}>
